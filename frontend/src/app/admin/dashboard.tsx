    ...
    >
      ...
      >
        <div className="flex justify-between items-center max-sm:mb-4">
          <Link href="/">
            <p className="mb-5 font-semibold max-sm:mb-3">
              {" "}
              <Image src={logoImg} alt="Logo" width={170} height={100} /> <br /> |
              Admin
            </p>
          </Link>
        ...
        <div className="p-0 my-2 h-full w-full overflow-hidden hover:overflow-y-auto">
          <Link href="/admin/dashboard">
            <label
              className={
                (!pathName.includes("/admin/dashboard") ? "btn-ghost " : "") +
                "btn w-full justify-start normal-case"
              }
              onClick={() => {}}
            >
              <FiHome /> Dashboard
          ...
          <Link href="/admin/shop">
            <label
              className={
                (!pathName.includes("/admin/shop") ? "btn-ghost " : "") +
                "btn w-full justify-start normal-case"
              }
              onClick={() => {}}
            >
          ...
          <Link href="/admin/purchases">
            <label
              className={
                (!pathName.includes("/admin/purchases") ? "btn-ghost " : "") +
                "btn w-full justify-start normal-case"
              }
              onClick={() => {}}
            >
          ...
          <Link href="/admin/faq">
            <label
              className={
                (!pathName.includes("/admin/faq") ? "btn-ghost " : "") +
                "btn w-full justify-start normal-case"
              }
              onClick={() => {}}
            >
          ...
          <Link href="/admin/users">
            <label
              className={
                (!pathName.includes("/admin/users") ? "btn-ghost " : "") +
                "btn w-full justify-start normal-case"
              }
              onClick={() => {}}
            >
        ...
        <hr />
        <Link href="/home">
          <label className="btn mb-2 mt-4 w-full">
            <FiArrowLeft /> USER HOME
          </label>
        </Link>
        <div
          tabIndex={0}
